...
impl CalldataAgnosticGas {
  ...
  fn calculate(input: &[u8], mut constant_zero_bytes: usize, gas_used: u64) -> u64 {
    ...
    gas_used +
      (calculate_initial_tx_gas(SpecId::OSAKA, &without_variable_zero_bytes, false, 0, 0, 0, 0)
        .initial_regular_gas() -
        calculate_initial_tx_gas(SpecId::OSAKA, input, false, 0, 0, 0, 0).initial_regular_gas())
  }
}
